        ...
        <div class="form-group col-md-12">
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    ...
                    if($update)
                        echo form_input('formation', set_value('formation', $apprentice->FK_Formation), 'maxlength="65535" class="form-control" id="formation"');
                        //echo form_dropdown('formation', $formations, set_value('formation', $apprentice->FK_Formation), 'class="form-control" id="formation"')
                    else
                        echo form_input('formation', set_value('formation'), 'maxlength="65535" class="form-control" id="formation"');
